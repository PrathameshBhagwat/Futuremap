...
const createRoadmapSchema = z.object({
  ...
  duration_months: z.number().optional().default(12),
  ...
  try {
    ...
    try {
      ...
      await db.from('users').upsert({
        ...
        first_name: session?.user_metadata?.first_name || null,
        last_name: session?.user_metadata?.last_name || null,
      ...
      const transformedRoadmap = {
        ...
        duration_months: savedRoadmap.duration_months,
      ...
      const mockRoadmap = {
        ...
        duration_months: validatedData.duration_months || 12,
