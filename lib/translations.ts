...
export const defaultTranslations: TranslationData = {
  ...
  hero: {
    ...
    stats: {
      ...
      collegesListed: 'Colleges Listed'
    }
  },
  
  featureCards: {
    sectionTitle: 'Powerful Features for Your Future',
    sectionSubtitle: 'Discover the tools and insights you need to make informed decisions about your career and education path.',
    personalizedQuiz: {
