...
export async function GET(
  ...
  try {
    ...
    const enhancedRoadmap = {
      ...
      // Pull ai_recommendations and timeline from roadmap_data
      ai_recommendations: roadmapData?.ai_recommendations || roadmap.ai_recommendations || null,
      timeline: roadmapData?.timeline || roadmap.timeline || null
    }
