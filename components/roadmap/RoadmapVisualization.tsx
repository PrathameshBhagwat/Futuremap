...
export default function RoadmapVisualization({ 
  ...
  return (
    <div className="w-full h-full relative bg-space-dark/50 rounded-xl border border-gray-800 overflow-hidden">
      ...
      {displayNodes.length === 0 ? (
        <div className="w-full h-full flex items-center justify-center">
          <div className="text-center text-gray-400">
            <p className="text-lg font-medium mb-2">Network View</p>
            <p className="text-sm">No nodes available. Please generate a roadmap with learning modules.</p>
          </div>
        </div>
      ) : (
        <>
      ...
      {/* Visualization Area - Pure Canvas */}
      <div 
        ref={containerRef}
        className="flex-1 relative bg-gradient-to-br from-gray-900/30 to-black/30 overflow-hidden"
      ...
      >
        ...
        {/* Zoom Controls */}
        <div className="absolute bottom-4 right-4 z-10 flex flex-col space-y-2 bg-gray-800/80 rounded-lg p-2 backdrop-blur-sm">
          <button
