...
export default function JobHuntingPage() {
  ...
  const searchingMessages = [
    ...
    "Curating your job list..."
  ]

  return (
    <div className="min-h-screen bg-space-dark text-white pt-16">
      <AnimatePresence>
        {analyzing && <DynamicSpinner fullscreen messages={analyzingMessages} intervalMs={2000} />}
        {searchingJobs && <DynamicSpinner fullscreen messages={searchingMessages} intervalMs={2000} />}
      </AnimatePresence>
