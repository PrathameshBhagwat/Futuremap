...
export default function AIRoadmapEnhanced() {
  ...
  return (
    <div className="min-h-screen bg-space-dark text-white relative overflow-hidden pt-8">
      {/* Enhanced Background */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          >
            {selectedRoadmap ? (
              <div className={`${isFullscreen ? 'fixed inset-0 z-50 bg-space-dark overflow-y-auto' : ''}`}>
                <div className={`${
                  isFullscreen 
                    ? 'min-h-full p-4 overflow-y-auto' 
                  ...
                  <motion.div 
                    ...
                    className={`${isFullscreen ? 'min-h-[600px]' : 'h-96'} relative overflow-y-auto rounded-xl`}
                  >
